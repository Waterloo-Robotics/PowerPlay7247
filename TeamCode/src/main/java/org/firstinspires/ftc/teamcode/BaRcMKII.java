...
//
        ...
        timer.reset();
        while (timer.seconds() < 0.5);
        attachmentControl.setArmPositions(3865, -2199, 0, true); //To Score
        attachmentControl.setArmPositions(3865, -2199, -750, true); //To Score
        this.servo(1); //Open
        ...
        switch (tagOfInterest.id) {
            ...
            case 1:
                ...
                odometryControl.forward(5, 0.0625);

                break;

            case 2:

                odometryControl.back(2, 0.0625);

                break;

            case 3:

                odometryControl.back(20, 0.0625);
